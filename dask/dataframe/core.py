...
Dask Name: {name}, {task} tasks"""
    ...
    def std(
        ...
        if is_df_like:
            ...
            needs_time_conversion = is_datetime_or_timedelta_dtype(self._meta_nonempty)
        ...
        if axis == 1:
            ...
            def sqrt_and_convert(p):
                ...
                mask = sqrt.index.isin(time_cols)
                matching_vals = sqrt[mask]
                sqrt.loc[mask] = pd.to_timedelta(matching_vals)
